...
def create_hole(
    ...
    match method:
        ...
        case "through_all":
            return feature_manager.create_hole_through_all(
                x=x, y=y, diameter=diameter, plane_index=plane_index, direction=direction
            )
        case "from_to":
        ...
        case "through_next":
            return feature_manager.create_hole_through_next(
                x=x, y=y, diameter=diameter, direction=direction, plane_index=plane_index
            )
        case "sync":
            return feature_manager.create_hole_sync(
                x=x, y=y, diameter=diameter, depth=depth, plane_index=plane_index
            )
        case "finite_ex":
        ...
        case "through_all_ex":
            return feature_manager.create_hole_through_all_ex(
                x=x, y=y, diameter=diameter, plane_index=plane_index
            )
        case "sync_ex":
            return feature_manager.create_hole_sync_ex(
                x=x, y=y, diameter=diameter, depth=depth, plane_index=plane_index
            )
        case "multi_body":
        ...
        case "sync_multi_body":
            return feature_manager.create_hole_sync_multi_body(
                x=x, y=y, diameter=diameter, depth=depth, plane_index=plane_index
            )
        case _:
